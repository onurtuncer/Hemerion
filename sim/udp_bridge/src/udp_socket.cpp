...
std::optional<UdpSocket> UdpSocket::create(const std::string& local_address, std::uint16_t local_port,
...
std::optional<std::size_t> UdpSocket::receive(void* buffer, std::size_t buffer_size,
