...
static_assert(std::is_trivially_copyable_v<ChannelFrame>,
              "ChannelFrame is sent byte-for-byte inside a UDP datagram");
...
static_assert(std::is_trivially_copyable_v<StepPacket>,
              "StepPacket is sent byte-for-byte as a single UDP datagram");
