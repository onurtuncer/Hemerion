...
# FindRenode.cmake
#
# Locates the Renode SWIL simulation platform (https://renode.io), used by
# tests/swil and sim/renode to run firmware without hardware.
#
# Usage: find_package(Renode [1.15] [REQUIRED])
# Exposes: Renode_FOUND, Renode_EXECUTABLE, Renode_VERSION, Renode::renode
# (imported EXECUTABLE target, usable as the COMMAND of add_test()/
# add_custom_command() entries that drive a .resc script).
#
# Search order: RENODE_ROOT / RENODE_HOME environment variables, then PATH,
# then the well-known install locations for each OS -- the antmicro/renode
# Linux package, the Windows installer's default Program Files directory,
...
elseif(APPLE)
  ...
  set(_renode_names renode)
  set(_renode_hints "$ENV{RENODE_ROOT}" "$ENV{RENODE_HOME}" "/opt/renode" "/opt/renode/bin" "/usr/local/bin" "/usr/bin")
endif()
...
find_package_handle_standard_args(
  Renode
  REQUIRED_VARS Renode_EXECUTABLE
  VERSION_VAR Renode_VERSION)
